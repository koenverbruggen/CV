...
\section{Repullo's optimal allocation of LLR responsibilities}
...
\caption{The central bank as LLR. Source: \protect\citeA{Repullo2000}.}
\label{fig:RepCB}
\end{centering}
\end{figure}
...
\caption{Optimal allocation of LLR powers. Source: \protect\citeA{Repullo2000}.}
\label{fig:RepDI}
\end{centering}
\end{figure}
